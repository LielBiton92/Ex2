...
public class DirectedWeightedGraphAlgorithmsImplTest {
    ...
    public void validateConnected() throws FileNotFoundException {
        DirectedWeightedGraphAlgorithms algorithms = loadGraphAlgorithem(new DirectedWeightedGraphImpl("data/G1.json"));
        assertTrue(algorithms.isConnected());
    }

    @Test
    public void validateNotConnected() throws FileNotFoundException {
        DirectedWeightedGraphAlgorithms algorithms = loadGraphAlgorithem(new DirectedWeightedGraphImpl("data/G4_NOT_CONNECTED.json"));
    ...
    public void validateSaveFile() throws FileNotFoundException {
        loadGraphAlgorithem(new DirectedWeightedGraphImpl("data/G5_SMALL_GRAPH.json")).save("test_save.json");
        DirectedWeightedGraph directedWeightedGraph = new DirectedWeightedGraphImpl("test_save.json");
        assertEquals(3, directedWeightedGraph.edgeSize());
        assertEquals(directedWeightedGraph.getEdge(0, 2).getWeight(), 1.0, 0.001);
        assertEquals(getCounterIterator(directedWeightedGraph.nodeIter()), 3);
    }
    ...
    public void validateLoadFile() {
        ...
        assertTrue(directedWeightedGraphAlgorithms.load("data/G5_SMALL_GRAPH.json"));
        assertEquals(3, directedWeightedGraphAlgorithms.getGraph().edgeSize());
        assertEquals(directedWeightedGraphAlgorithms.getGraph().getEdge(0, 2).getWeight(), 1.0, 0.001);
        assertEquals(getCounterIterator(directedWeightedGraphAlgorithms.getGraph().nodeIter()), 3);
    }
    ...
    @Test
    public void validate_1000Nodes() throws FileNotFoundException {
    ...
    @Test
    public void validate_10000Nodes() throws FileNotFoundException {
        long start = System.currentTimeMillis();
